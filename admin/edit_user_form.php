										...
										<div class="control-group">
                                          ...
                                          <div class="controls">
                                            <select name="region"  class="" required>
												...
												<option value ="Legal and Investigation Division"> Legal and Investigation Division</option>
												<option value ="Security / Intelligence Division"> Security / Intelligence Division</option>
												<option value ="Navigation / Communication Division"> Navigation / Communication Division</option>
												<option value ="Maritime Safety Services"> Maritime Safety Services</option>
...
mysqli_query($conn,"insert into activity_log (date,username,action) values(NOW(),'$user_name','Edit User $username from $region')")or die(mysqli_error());
//this is Real
