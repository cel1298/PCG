...
while ($row = $cleanupQuery->fetch()) {
    $filePath = "../../public_file/upload/" . $row['fname'];
...
if (isset($_POST['submit']) != "") {
    ...
    if ($chk) {
        ...
        $move = move_uploaded_file($temp, "../../public_file/upload/" . $fname);
        if ($move) {
            // Check if the file actually exists in the folder
            if (file_exists("../../public_file/upload/" . $fname)) {
        ...
        <div class="container">
            ...
            <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                ...
                while ($row = $query->fetch()) {
                    ...
                    $filePath = "../../public_file/upload/" . $fname;
                    if (!file_exists($filePath)) {
                ...
                <tr>
                    ...
                    <td>
                        <button class="alert-success">
                            <a href="../../public_file/download.php?filename=<?php echo urlencode($name); ?>&f=<?php echo urlencode($fname); ?>">Download</a>
                        </button>
                    </td>
                </tr>
                <?php } ?>
